classdef MissionManager < handle
    ...
    methods
        ...
        function updateMissionPhase(obj, mgrL, mgrR, coop_system)
            % INPUT: 
            % - mgrL: ActionManager braccio sinistro
            % - mgrR: ActionManager braccio destro
            % - coop_system: Sistema simulato (contiene stato robot)
            ...
            switch obj.missionPhase
                ...
                case 1 % --- PHASE 1: REACH GRASPING POINTS ---
                    ...
                    % Assumo che nel main tu abbia chiamato i task 'CART_L' e 'CART_R'
                ...
                case 2 % --- PHASE 2: COOPERATIVE MANIPULATION ---
                    ...
                    % Monitoriamo l'errore dell'oggetto rispetto al goal
                    % Possiamo usare direttamente i metodi dei robot o recuperare il task
